...
include(":features:bottomMenu:location:api")
include(":features:bottomMenu:location:presentation")
include(":features:bottomMenu:location:domain")
include(":features:bottomMenu:location:data")
